...
const int16 O_GCP_VER_OFF = 0x8;


// main offsets we touch
uint16 O_GHOSTCLIPPLAYER_CURR_TIME = 0x1A4 + O_GCP_VER_OFF;
uint16 O_GHOSTCLIPPLAYER_DO_MOTION_INTERP = 0x30C + O_GCP_VER_OFF; // not correctly labeled, something to do with this but not exactly as named
uint16 O_GHOSTCLIPPLAYER_TOTAL_TIME = 0x320 + O_GCP_VER_OFF;
uint16 O_GHOSTCLIPPLAYER_TIME_SPEED_3 = 0x324 + O_GCP_VER_OFF;
uint16 O_GHOSTCLIPPLAYER_SMOOTH_PAUSE = 0x330 + O_GCP_VER_OFF;

// other offsets
uint16 O_GHOSTCLIPPLAYER_FRAME_DELTA = 0x2F8 + O_GCP_VER_OFF;
uint16 O_GHOSTCLIPPLAYER_CURR_TIME2 = 0x2FC + O_GCP_VER_OFF;
uint16 O_GHOSTCLIPPLAYER_TIME_SPEED_1 = 0x1A8 + O_GCP_VER_OFF;
uint16 O_GHOSTCLIPPLAYER_TIME_SPEED_2 = 0x300 + O_GCP_VER_OFF;
uint16 O_GHOSTCLIPPLAYER_START_TIME = 0x308 + O_GCP_VER_OFF;
// editing this toggles the play/pause button in MT but does not actually pause playback. maybe it is a flat like CanPause
uint16 O_GHOSTCLIPPLAYER_IS_PLAYING = 0x30C + O_GCP_VER_OFF;
